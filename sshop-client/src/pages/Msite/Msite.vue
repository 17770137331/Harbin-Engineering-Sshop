<template>
  <section class="msite">
          ...
          <div class="swiper-slide" v-for="(pages,index) in categorysArr" :key="index">
            <a href="javascript:" class="link_to_food" v-for="(data,index) in pages" :key="index">
              <div class="food_container">
                <img :src="baseImageUrl+data.link" >
              </div>
    ...
    <!--首页附近商家列表-->
    <div class="msite_shop_list" style="overflow:hidden;">
      <div class="shop_header">
        <i class="iconfont icon-liebiao"></i>
        <span class="shop_header_title">二手好物</span>
      </div>
...
export default {
  ...
  mounted () {
    ...
    localStorage.setItem("mytest","1849")
  }
}
</script>
